...
3. frontmatter 格式：
   ...
   ---
4. 代码相关对话：
   - 保留原始对话（用户问题 + AI回复原文），不做摘要
   - 代码块只保存重点片段
   - 每处代码修改必须解释修改理由（why）和涉及的基础知识点
5. 非代码对话：提炼要点摘要
6. 内容过多时：先列出主题目录计划，问用户哪些需要详细整理
7. 官方文档参考：优先中英文链接
...
- [x] 首次跨对话整理完成 ✅ 2026-05-28
  - 整合了 4 个 Claude Code 会话（obsidian-vault ×1、vpp-simulator ×3、naval-class ×1）
