...
multiFile:
multiMedia:
description: 小满 React 教程「学习React【工具】Babel」笔记。素材来源 message163.github.io/react-docs。
笔记类型: 收集笔记
阐述日期:
tags:
  - React
...
> 素材来源：[小满 React 文档](https://message163.github.io/react-docs/react/tools/babel.html)
...
如何支持新特性例如 `Object.assign` `Array.prototype.find` 等，index.js 增强编译：
...
编写代码只需要增加一个预设即可 `@babel/preset-react`：
...
转换的结果（其实也就是调用了 `React.createElement` 去创建元素）：
