...
multiFile:
multiMedia:
description: 小满 React 教程「学习React【Hooks】useCallback」笔记。素材来源 message163.github.io/react-docs。
笔记类型: 收集笔记
阐述日期:
tags:
  - React
...
> 素材来源：[小满 React 文档](https://message163.github.io/react-docs/react/hooks/useCallback.html)
...
![函数被重新创建](https://message163.github.io/react-docs/assets/useCallback-1.BFbfZsfH.png)
...
![函数未被重新创建](https://message163.github.io/react-docs/assets/useCallback-2.Cx2UWwdd.png)
...
![子组件被重新渲染](https://message163.github.io/react-docs/assets/useCallback-3.Bd3ynv-p.png)
