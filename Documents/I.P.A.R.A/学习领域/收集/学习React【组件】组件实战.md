...
multiFile:
multiMedia:
description: 小满 React 教程「学习React【组件】组件实战」笔记。素材来源 message163.github.io/react-docs。
笔记类型: 收集笔记
阐述日期:
tags:
  - React
...
> 素材来源：[小满 React 文档](https://message163.github.io/react-docs/react/components/practice.html)
...
> 这一章建议大家看完 `hooks` `css` `组件` 这些章节之后再来看，这样会更好理解。本章是额外新增的，因为之前的知识大家都掌握的差不多了，所以这一章节主要是让大家动手实践，巩固一下前面的知识。
