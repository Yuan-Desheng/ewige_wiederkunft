...
multiFile:
multiMedia:
description: 小满 React 教程「学习React【Hooks】useTransition」笔记。素材来源 message163.github.io/react-docs。
笔记类型: 收集笔记
阐述日期:
tags:
  - React
...
> 素材来源：[小满 React 文档](https://message163.github.io/react-docs/react/hooks/useTransition.html)
...
为了更好的测试结果可以在浏览器性能面板中降级 cpu 渲染速度。
