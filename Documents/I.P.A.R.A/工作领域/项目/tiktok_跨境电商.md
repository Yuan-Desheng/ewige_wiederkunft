...
fastmoss选品，只改变必须选择跨境店

采集部分从1688采集变为从fastmoss商品详情页直接跳转到 https://shop.tiktok.com/ 去采集
...
接下来的步骤和采集1688商品的步骤类似，不过可以简便很多，从 tiktokshop 采集到的产品标题、描述、图片等信息都是英文的，不需要修改了
我们主要修改商品的sku价格（其他编辑项也按照要求检查并填写一下）

合算价格，这里的价格需要和1688商品价格对一下，可以包的住
![[Pasted image 20260903153118.png]]

填写价格
![[Pasted image 20260903153220.png]]

然后就可以保存并发布到tiktok店铺了

后面的步骤就和1688采集商品的步骤一样了

## 商品机会

平台根据我们的上品，推荐的高潜力商品

这些商品我们可以去合算一下价格，看看我们的店铺能否上这个品
